...
public class EntityTurkey extends EntityAnimal
{
   ...
   public EntityTurkey(World world)
   {
      ...
      this.tasks.addTask(3, new EntityAITempt(this, 1.0D, ItemManager.foodCrop, false));
   ...
   {
      return Reference.GB_AUDIO_PREFIX + "mob.turkey.say";
   }
   ...
   protected void dropFewItems(boolean hitByPlayer, int looting)
   {
      ...
      if (this.isBurning())
      {
         this.entityDropItem(new ItemStack(ItemManager.meat, 1, 7), 0.0F);
      }
      else
      {
         this.entityDropItem(new ItemStack(ItemManager.meat, 1, 6), 0.0F);
      }
   }
    ...
    * 
    * @param stack
    *           - ItemStack representing the breeding item
    */
   public boolean isBreedingItem(ItemStack stack)
   {
      return stack != null && stack.getItem() == ItemManager.foodCrop
               && stack.getItemDamage() > 23 && stack.getItemDamage() < 30;
   }
}

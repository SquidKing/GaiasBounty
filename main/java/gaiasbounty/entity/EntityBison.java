...
public class EntityBison extends EntityAnimal
{
   ...
   {
      return Reference.GB_AUDIO_PREFIX + "mob.bison.say";
   }
   ...
   {
      return Reference.GB_AUDIO_PREFIX + "mob.bison.hurt";
   }
   ...
   protected void dropFewItems(boolean hitByPlayer, int looting)
   {
      ...
      for (k = 0; k < j; ++k)
      {
         if (this.isBurning())
         {
            this.entityDropItem(new ItemStack(ItemManager.meat, 1, 5), 0.0F);
         }
         else
         {
            this.entityDropItem(new ItemStack(ItemManager.meat, 1, 4), 0.0F);
         }
      }
   }

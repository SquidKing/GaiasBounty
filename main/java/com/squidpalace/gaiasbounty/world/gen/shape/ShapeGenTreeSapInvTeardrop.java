package com.squidpalace.gaiasbounty.world.gen.shape;
...
public class ShapeGenTreeSapInvTeardrop extends ShapeGenTree
{
    public static final ShapeGenTree instance = new ShapeGenTreeSapInvTeardrop();
